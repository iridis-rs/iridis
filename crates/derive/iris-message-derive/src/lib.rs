...
fn struct_derive(name: Ident, fields: Punctuated<Field, Comma>) -> TokenStream {
    ...
    let expanded = quote! {
        impl ArrowMessage for #name {
            fn field(name: impl Into<String>) -> iris_message::prelude::thirdparty::arrow_schema::Field {
                make_union_fields(
                    name,
                    vec![
                        #(#fields_fill)*
            ...
            fn try_from_arrow(data: iris_message::prelude::thirdparty::arrow_data::ArrayData) -> iris_message::prelude::thirdparty::eyre::Result<Self>
            where
                Self: Sized,
            {
            ...
            fn try_into_arrow(self) -> iris_message::prelude::thirdparty::eyre::Result<iris_message::prelude::thirdparty::arrow_array::ArrayRef> {
        ...
        impl TryFrom<iris_message::prelude::thirdparty::arrow_data::ArrayData> for #name {
            type Error = iris_message::prelude::thirdparty::eyre::Report;

            fn try_from(data: iris_message::prelude::thirdparty::arrow_data::ArrayData) -> iris_message::prelude::thirdparty::eyre::Result<Self> {
                #name::try_from_arrow(data)
            }
        }

        impl TryFrom<#name> for iris_message::prelude::thirdparty::arrow_data::ArrayData {
            type Error = iris_message::prelude::thirdparty::eyre::Report;

            fn try_from(item: #name) -> iris_message::prelude::thirdparty::eyre::Result<Self> {
                use iris_message::prelude::thirdparty::arrow_array::Array;
...
fn enum_derive(name: Ident, variants: Punctuated<Variant, Token![,]>) -> TokenStream {
    ...
    let expanded = quote! {
        impl #name {
            ...
            pub fn try_from_string(s: String) -> iris_message::prelude::thirdparty::eyre::Result<Self> {
                match s.as_str() {
                    #(#try_from_string_arms)*
                    _ => Err(iris_message::prelude::thirdparty::eyre::eyre!("Invalid value for {}: {}", stringify!(#name), s)),
                }
            }
        }
